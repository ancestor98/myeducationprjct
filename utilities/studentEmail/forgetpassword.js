                  ...
                  <tr>
                      <td>
                          <div style="padding: 0 2.5em; text-align: center;">
                              <h2 style="font-family: 'Lato', sans-serif; color: rgba(0,0,0,.3); font-size: 40px; margin-bottom: 0; font-weight: 400;">Welcome to ProgressPal <br/> Forgot your password?</h2>
                              <h3 style="font-family: 'Lato', sans-serif; font-size: 24px; font-weight: 300;">it's okay, Kindly click on the button to reset your password. <br/> Please note that this link will expire after 5(five) Minutes.</h3>
                              <p><a href=${link} class="btn btn-primary" style="padding: 10px 15px; display: inline-block; border-radius: 5px; background: #87CEEB; color: black; text-decoration: none;">Reset Password</a></p>
                          </div>
                      </td>
                  </tr>
              </table>
