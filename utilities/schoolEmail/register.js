                  ...
                  <tr>
                      <td>
                          <div style="padding: 0 2.5em; text-align: center;">
                              ...
                              <h3 style="font-family: 'Lato', sans-serif; font-size: 24px; font-weight: 300;">Please, click on the button below to verify your account.</h3>
                              <p><a href=${link} class="btn btn-primary" style="padding: 10px 15px; display: inline-block; border-radius: 5px; background: #87CEEB; color: black; text-decoration: none;">Verify</a></p>
                          </div>
                      </td>
                  </tr>
              </table>
